...
| `implementComparable`   | `Boolean` | Tagged value defines if the Java representation of this type should implement interface `java.lang.Comparable`.<br><br>By default the property is set to `false`. |
